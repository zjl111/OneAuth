...
export default function IntegrationsPage() {
  ...
  return (
    <div className="integrations-page">
      ...
      >
        <Form form={form} layout="vertical" initialValues={emptyConfig()}>
          <div className="integration-section">
            ...
            <div className="integration-grid">
              ...
              <Form.Item label="平台类型" name="platform_type">
                <Select
                  options={[
                    { label: '企微后台通讯录', value: 'wecom_attendance' },
                  ]}
                />
              </Form.Item>
              ...
              <Form.Item label="API Key" extra="可以在这里生成，然后复制到企微后台「SSO 接入」中授权。保存后留空表示不修改已保存 Key。">
                <Space.Compact style={{ width: '100%' }}>
                  ...
                  <Button icon={<KeyOutlined />} onClick={fillGeneratedApiKey}>
                    生成
                  </Button>
                </Space.Compact>
              </Form.Item>
          ...
          <div className="integration-section">
            ...
            <Space style={{ marginBottom: 12 }}>
              <Button icon={<CloudSyncOutlined />} loading={loadingRemote} onClick={loadRemoteDepartments}>
                保存并拉取远端部门
              </Button>
            </Space>
      ...
      <div className="integration-actions">
        ...
        <Button type="primary" icon={<CloudSyncOutlined />} loading={syncing === 'run'} onClick={doRun}>
          立即同步
        </Button>
      </div>

      {summary && (
        <Card title={summary.dry_run ? '预览结果' : '同步结果'} className="integration-result">
