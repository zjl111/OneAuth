...
func seedSystemConfigs(db *gorm.DB) error {
	configs := []model.SystemConfig{
		...
		{Category: "notice", Key: "enabled", Value: "false", Description: "是否启用门户公告"},
		{Category: "notice", Key: "text", Value: "", Description: "门户公告内容（横向滚动显示在门户页顶部，留空则不显示）"},
		...
		{Category: "security", Key: "password_require_uppercase", Value: "true", Description: "密码是否必须包含大写字母"},
		{Category: "security", Key: "password_require_lowercase", Value: "true", Description: "密码是否必须包含小写字母"},
		{Category: "security", Key: "password_require_digit", Value: "true", Description: "密码是否必须包含数字"},
		{Category: "security", Key: "password_require_special", Value: "true", Description: "密码是否必须包含特殊字符"},
		...
		{Category: "directory_sync", Key: "enabled", Value: "false", Description: "是否启用第三方通讯录同步"},
		{Category: "directory_sync", Key: "platform_type", Value: "wecom_attendance", Description: "第三方平台类型"},
		{Category: "directory_sync", Key: "base_url", Value: "", Description: "第三方平台地址"},
		{Category: "directory_sync", Key: "api_key", Value: "", Description: "第三方平台 API Key（保存后不再回显）"},
		{Category: "directory_sync", Key: "selected_department_paths", Value: "[]", Description: "需要同步的部门路径 JSON 数组"},
		{Category: "directory_sync", Key: "strip_prefix", Value: "", Description: "同步到本地前裁掉的部门路径前缀"},
		{Category: "directory_sync", Key: "mount_department_id", Value: "", Description: "同步挂载到本地哪个部门下，空表示根目录"},
		{Category: "directory_sync", Key: "deactivate_missing", Value: "true", Description: "远端缺失的已同步用户是否自动禁用"},
		{Category: "directory_sync", Key: "username_strategy", Value: "smart_pinyin", Description: "用户名生成策略"},
		{Category: "directory_sync", Key: "field_mapping", Value: `{"external_id":"externalId","username":"userId","nickname":"userName","email":"email","phone":"phone","position":"position","department_path":"departmentPath","department_paths":"departmentPaths","active":"isActive"}`, Description: "第三方字段到 OneAuth 字段的映射 JSON"},
